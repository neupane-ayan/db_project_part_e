...
LOAD DATA LOCAL INFILE './table_MetroArea-small.csv' 
...
LOAD DATA LOCAL INFILE './table_PlaysOn-small.csv' 
INTO TABLE PlaysOn
FIELDS
  TERMINATED BY ','
  ENCLOSED BY '"'
...
LOAD DATA LOCAL INFILE './table_Players-small.csv' 
INTO TABLE Player
FIELDS
  TERMINATED BY ','
  ENCLOSED BY '"'
...
LOAD DATA LOCAL INFILE './Teams_relation-small.csv' 
INTO TABLE Team
FIELDS
  TERMINATED BY ','
  ENCLOSED BY '"'
...
LOAD DATA LOCAL INFILE './Season_relation-small.csv' 
INTO TABLE Season
FIELDS
  TERMINATED BY ','
  ENCLOSED BY '"'
...
LOAD DATA LOCAL INFILE './TeamRecord_relation-small.csv' 
